...
import { saveStory, deleteStory, isStorySaved } from '../../../utils/indexedDB';
      ...
      <div class="story-detail">
        ...
        <div class="detail-info">
          ...
          <div class="story-actions">
            <button id="save-story-btn" class="btn ${isSaved ? 'btn-danger' : 'btn-primary'}">
              ${isSaved ? 'Buang Cerita' : 'Simpan Cerita'}
            </button>
    ...
    saveButton.addEventListener('click', async () => {
      try {
        if (isSaved) {
          ...
          saveButton.textContent = 'Buang Cerita';
          saveButton.classList.remove('btn-primary');
          saveButton.classList.add('btn-danger');
        }
      } catch (error) {
        console.error('Error saving/deleting story:', error);
        alert('Gagal menyimpan/menghapus cerita');
      }
    });
